...
// pulls ems indication for car 2 from field 8
...
// send ems indication to field 2
function emsIcon() {
  z = 1; 
  var url = 'https://api.thingspeak.com/update?api_key=NUQD36RO2XTFH4TA&field2=1';
...
function citizenIcon() {
  z = 0;
  var url = 'https://api.thingspeak.com/update?api_key=NUQD36RO2XTFH4TA&field2=0';
